...
export const events = sqliteTable('events', {
  ...
  scheduledInviteAt: text('scheduled_invite_at'),
  scheduledDayOfConfirmAt: text('scheduled_day_of_confirm_at'),
  scheduledGroupChatAt: text('scheduled_group_chat_at'),
  dayOfConfirmSentAt: text('day_of_confirm_sent_at'),
